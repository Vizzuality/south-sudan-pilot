...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "focus:ring-ring-casper-blue-400 flex w-full items-center justify-between border border-casper-blue-400 bg-casper-blue-50 px-3 py-2 text-sm transition-colors placeholder:text-rhino-blue-950 hover:bg-casper-blue-200 focus:outline-none focus:ring-2 disabled:cursor-not-allowed disabled:opacity-20 data-[state=open]:bg-casper-blue-200 [&>span]:line-clamp-1",
      className,
    )}
    {...props}
  >
